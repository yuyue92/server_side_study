...
// 加载图标
export const LoadingIcon: React.FC<IconProps> = ({ className, size = 18 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
// 停止图标
export const StopIcon: React.FC<IconProps> = ({ className, size = 18 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
// 锁图标
export const LockIcon: React.FC<IconProps> = ({ className, size = 18 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
// SSE 图标
export const ZapIcon: React.FC<IconProps> = ({ className, size = 18 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
